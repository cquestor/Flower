  ...
  <div id="container">
    <div id="leftPane">
      ...
      <div id="sidebar">
        ...
        <a
          href="../../../static/FlowerEpidemicview/login.html"
          class="sidebtn"
        >
          <svg
            t="1667141909552"
  ...
  methods: {
    ...
    search() {
      if (this.searchName == "") {
        ...
        searchFlower(this.searchName).then(res => {
          if (res.statusCode === 200) {
            this.$bus.emit("success", res.message);
            this.$router.push({
              name: "flower",
              params: { flowers: res.data }
            });
          } else {
